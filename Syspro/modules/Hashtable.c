...
/*--------------------------Function that creates and initializes Hash table --------------------------*/
...
/*--------------------------Function that checks if an entry str is placed in a hashtable ----------------*/
...
/*--------------------------Function that inserts entry in hashtable ------------------------------------*/
...
/*--------------------------Function that destroys a Hashtable ------------------------------------*/
